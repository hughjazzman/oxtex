...
\[\Delta(f:A\rightarrow B) = \begin{cases}
    ...
    \emptyset \mapsto \{*\} & \text{if } A=\emptyset \wedge B\neq \emptyset\\
    1_{\{*\}} & \text{if } A\neq\emptyset
\end{cases}
\]
...
We have $\phi(t) \in H\ A$, so define
