...
\begin{example}
% https://q.uiver.app/#q=
\[\begin{tikzcd}
	\bullet && \bullet &&&& \bullet && \bullet
	\arrow["f", shift left, from=1-1, to=1-3]
	\arrow["{F\ f}", shift left, from=1-7, to=1-9]
	\arrow["{(F\ f)^{-1}=F\ g}", shift left, from=1-9, to=1-7]
...
The functor $F:\mathcal{C}\rightarrow\mathcal{D}$ is clearly faithful.
