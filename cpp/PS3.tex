...
% https://q.uiver.app/#q=
\[\begin{tikzcd}
	{A\times B} && B &&& {A\times B} && {\pi_2} \\
	\\
	A\arrow["1_A", loop below] &&&&& A\arrow["1_A", loop below]
	\arrow["f"', from=3-1, to=1-3]
	\arrow["{\langle1_A,f\rangle}"', shift right, dashed, from=3-1, to=1-1]
	\arrow["{\pi_1}"', shift right, from=1-1, to=3-1]
	\arrow["{\pi_2}", from=1-1, to=1-3]
	\arrow["{\pi_2}", from=1-6, to=1-8]
	\arrow["{\pi_1}"', shift right, from=1-6, to=3-6]
	\arrow["{\langle 1_A,g\rangle}"', shift right, dashed, from=3-6, to=1-6]
	\arrow["g"', from=3-6, to=1-8]
\end{tikzcd}\]

Then we show that $\pi_1:A\times B\rightarrow A$ is the equaliser of $(f,g)$.
By the product, we then have
\[f\circ \pi_1 = \pi_2 = g \circ \pi_1\]
Suppose we then have a morphism $h:C\rightarrow A$ such that $f\circ h=g\circ h$.
Then by the product, there is a unique morphism $\hat{h}=\langle h, f\circ h\rangle:C\rightarrow A\times B$ 
such that $h=\pi_1\circ \hat{h}$. 
% https://q.uiver.app/#q=
\[\begin{tikzcd}
	{A\times B} && A && B \\
	\\
	C
	...
	\arrow["{f\circ h = g\circ h}"', from=3-1, to=1-5]
	\arrow["f", shift left, from=1-3, to=1-5]
	\arrow["{\langle h,f\circ h\rangle}", dashed, from=3-1, to=1-1]
	\arrow["g"', shift right, from=1-3, to=1-5]
	\arrow["{\pi_2}", curve={height=-24pt}, from=1-1, to=1-5]
\end{tikzcd}\]
