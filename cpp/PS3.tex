...
Writing this here because I keep mixing them up.
...
\[(S\ f) (1_A\circ 1_A) = (S\ f)(1_A) = 1_{(S\ f) (1_A)}\]
\end{proof}
...
Functoriality is preserved since
...
\[\begin{tikzcd}
	...
	\arrow["{\gamma_m}"', from=3-3, to=1-5]
	\arrow["{\gamma_n}", from=3-3, to=1-1]
\end{tikzcd}\]
