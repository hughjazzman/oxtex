...
&= \mathbb{E}[X_2 | X_1]\mathbb{E}[X_1|X_1] \quad\text{(since $X_1,X_2$ independent, given $X_1$)}\\
&= \mathbb{E}[X_2]\mathbb{E}[X_1|X_1] \quad\text{(since $X_1,X_2$ independent)}\\
...
&=\prod_{i=1}^n \left(\frac{q}{p}\right)^{p-q}\\
&< \infty
\end{aligned}
\end{equation}
