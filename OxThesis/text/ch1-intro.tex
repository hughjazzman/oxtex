...
The proof \cite{Kissinger2024} makes use of the fact that Hadamard edges in parallel cancel,
...
It turns out that there is an algorithm that is bounded in $O(n^3)$ where $n$ is the number of spiders,
