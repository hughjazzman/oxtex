...
\usepackage[style=numeric-comp, sorting=none, backend=biber, doi=false, isbn=false, abbreviate=false, maxbibnames=5]{biblatex}
...
\title{Efficient Heuristics for Classical Simulation of Quantum Circuits Using ZX-Calculus}
...
\include{text/ch4-results}
\include{text/ch5-conclusion}
